...
library(sdmTMB)
library(tibble)
#devtools::load_all("C:/Users/vladlena.gertseva/Documents/GitHub/indexwc")

configuration_ytk <- configuration |>
  dplyr::filter(species == "big skate")
...
#> [1] 10
# View page 2
print(plot1 + ggforce::facet_wrap_paginate("year", nrow = 1, ncol = 1, page = 2))
...
save_index_outputs(
  ...
  indices = index,
  dir_main = paste0(getwd(), "/big_skate_cog_pt conception")
)

write.csv(index$cogs,"big_skate_cog.csv")
